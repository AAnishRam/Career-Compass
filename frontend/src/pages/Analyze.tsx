...
export default function Analyze() {
  ...
  const handleAnalyze = (data: { jobDescription: string; resumeText: string }) => {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
            Paste a job description and your resume to get an instant analysis of how well you match the requirements.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <JobInputForm onAnalyze={handleAnalyze} />
          </div>

          {/* Features Sidebar */}
          <div className="space-y-4">
            <h3 className="font-display font-semibold text-foreground mb-4">Why Use JobMatch?</h3>
            ...
            <div className="glass-card rounded-xl p-5 border-l-4 border-l-primary mt-6">
              <h4 className="font-display font-semibold text-foreground">Pro Tip</h4>
              <p className="text-sm text-muted-foreground mt-2">
                For the best results, paste the complete job description including requirements, 
